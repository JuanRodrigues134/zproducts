		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products",
									"targetURL": "#comudozproducts2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comudozproducts2-display": {
								"semanticObject": "comudozproducts2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.udo.zproducts2",
									"url": sap.ui.require.toUrl("com/udo/zproducts2")
								}
							}
						}
					}
